...
import { FormControl, FormLabel, FormErrorMessage, FormHelperText, Input, Box } from "@chakra-ui/react";
        ...
        <Box w="100%" h="100%" backgroundColor="#FFF5F7">
            <form onSubmit={handleSubmit(onSubmit)}>
                <FormControl isInvalid={!!errors.domain}>
                    ...
                    {!errors.domain && <FormHelperText>Please enter your GoodData domain</FormHelperText>}
                    ...
                    {!errors && <FormHelperText>Please enter your API Token</FormHelperText>}
